...
export default function PlantingTrackerScreen() {
  ...
  const handleSave = () => {
    ...
    Alert.alert('Success', 'Planting tracker saved successfully!');
  };
  ...
  const handleViewRecords = () => {
    Alert.alert('View Records', 'This will show all saved planting tracker records');
  };
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.formContainer}>
          ...
          {/* Area Planted Section */}
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <MaterialCommunityIcons name="sprout" size={24} color={GREEN} />
              <Text style={styles.sectionTitle}>Area Planted (Hectares)</Text>
            </View>
            ...
            <View style={styles.totalContainer}>
              <Text style={styles.totalLabel}>Total Area Planted:</Text>
